...
if (isset($_POST['ajouter'])) {
    if (!empty($_POST['title']) && !empty($_POST['type']) && !empty($_POST['descri'])) {
        ...
        $insert = $bdd->prepare('INSERT INTO bdc.skills_acquis (title, types, descriptions, `user_id`, create_time)
        VALUES (?, ?, ?, ?, NOW())');
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 order-2 order-md-1 text-center text-md-left">
                    <center>
                        <h2 style="color: white; ">Ajouter une compétence acquise</h2> <br>
                    </center>
                    <form method="post">
                        ...
                        <center>
                            <div class="form-group">
                                ...
                                <a href="../views/accueil.php#acquis" class="btn btn-sm btn-outline-danger">Retour</a>
                            </div>
                        </center>
                    </form>
                </div>
